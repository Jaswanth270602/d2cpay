                    ...
                    <div class="card-body">
                        ...
                        <table class="table main-table-reference mt-3 mb-0">
                            ...
                            <tr>
                                ...
                                <td>numeric</td>
                                <td>Order amount in INR. Must be between ₹500 and ₹25,000.</td>
                                <td>Yes</td>
                            </tr>
                            <tr>
...
<pre>curl -X POST "{{ url('api/add-money/v12/createOrder') }}" \
  ...
  -d "email=test@example.com"</pre>
                    ...
                    <div class="card-footer">
                        <pre>POST: {{ url('api/add-money/v12/createOrder') }}</pre>
                        <hr>
...
{
    "status": "failure",
    "message": "The amount must be between 500 and 25000."
}
or
{
    "status": "failure",
...
or
{
    ...
    "message": "AurexaPay credentials not configured"
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>POST: {{ url('api/add-money/v12/status-enquiry') }}</pre>
                        <hr>
