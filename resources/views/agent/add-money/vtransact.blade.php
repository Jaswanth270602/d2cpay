...
<style>
    ...
    #error-card button:hover { background: #d00000; }
</style>
...
<div class="main-content-body d-flex justify-content-center align-items-center" style="min-height:100vh;">
    <div class="col-md-5 unique-form-wrapper" id="form-wrapper">
        <div class="unique-card">
            ...
            <p class="unique-sub">Generate a QR instantly by entering the amount</p>
            ...
            <button class="btn-neon mt-2" id="generateBtn" onclick="createOrder()" disabled>⚡ Generate QR Code</button>
...
<script>
    function toggleBtn() {
        ...
        if (!isNaN(amount) && amount >= 100 && amount <= 20000) {
            ...
            btn.disabled = true;
            if (amount) {
                errorField.textContent = "Enter amount between 100 and 20000";
            } else {
                errorField.textContent = "";
            }
        }
